...
class Config:
    ...
    max_rounds:int=5; max_workers:int=3; claude_timeout_s:int=900; codex_timeout_s:int=600; plan_retry_max:int=2; claude_model:str=""; claude_permission_mode:str="plan"; codex_sandbox:str="workspace-write"; codex_model:str=""; codex_approve_for_me:bool=True; coverage_threshold:float=.8; max_rounds_no_progress:int=2; verbose:bool=False
